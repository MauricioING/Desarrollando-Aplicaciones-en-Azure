...
namespace SitioMVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ApplicationDbContext context, IAlmacenadorArchivos almacenadorArchivos,
            IRepositorioPerfiles repositorioPerfiles, IQueueServicio queueServicio)
        {
        ...
        public async Task<IActionResult> Crear(PersonaCrearDTO personaCrearDTO)
        {
            ...
            var persona = new Persona
            {
                ...
                Correo = personaCrearDTO.Correo
            };
            context.Add(persona);
            await context.SaveChangesAsync();

            var mensajeOptimizarImagenPersona = new MensajeOptimizarImagenPersona(persona.Id, fotoURL);

            var mensajeOptimizarImagenPersonaJSON = JsonSerializer.Serialize(mensajeOptimizarImagenPersona);

            await queueServicio.EscribirMensaje("optimizar-imagenes-personas", mensajeOptimizarImagenPersonaJSON);
